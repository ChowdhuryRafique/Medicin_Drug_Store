<div>
    <div>
        <div>
            ...
            <form action="{{route('medicinCreate')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Medicine Name:</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="Type Name" placeholder="Enter Name" name="medicinName">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Medicine Quantity:</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="Type Name" placeholder="Enter Quantity" name="medicinQuantity">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Medicine Price:</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="Type Name" placeholder="Enter Price" name="medicinPrice">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="Type Name" placeholder="Write Description" name="medicinDescription">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Company Name
                        :</label>
                    <div class="col-sm-10">
                        <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="medicinSelect">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="diseaseName">
                            <option selected>Choose One</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="file" class="form-control" id="Type Name" placeholder="Upload Image" name="imageupload">
                    </div>
                </div>
